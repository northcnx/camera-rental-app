...
//   // ประกาศตัวแปรสำหรับ Supabase Client
...
//   // ฟังก์ชันลบสินค้าออกจากตะกร้า (ปุ่มถังขยะ)
//   Future<void> removeCart(String cartId) async {
//     await supabase.from('carts').delete().eq('id', cartId);
//     setState(() {
//       cartFuture = fetchCart(); // รีโหลดหน้าจอ
//     });
//   }

//   // --- ฟังก์ชันยืนยันการเช่า (ฉบับสมบูรณ์) ---
//   Future<void> confirmRent(List<dynamic> cartItems) async {
//     setState(() {
...
//       // วนลูปสินค้าทุกชิ้นในตะกร้า
//       for (var item in cartItems) {
//         final cameraId = item['cameras']['id'];
//         final cartId = item['id'];

//         // 1. อัปเดตตาราง cameras:
//         // - is_active = false (ของไม่ว่างแล้ว)
//         // - rented_by = user.id (บันทึกว่า "ใคร" เป็นคนเช่า)
//         await supabase
//             .from('cameras')
//             .update({
//               'is_active': false,
//               'rented_by': user.id, // <--- บันทึก ID ผู้เช่าลงไปตรงนี้
//             })
//             .eq('id', cameraId);

//         // 2. ลบออกจากตาราง carts (เพราะเช่าไปแล้ว ไม่ต้องอยู่ในตะกร้า)
//         await supabase.from('carts').delete().eq('id', cartId);
//       }
...
//           const SnackBar(
//             content: Text('ยืนยันการเช่าสำเร็จ! ข้อมูลถูกบันทึกแล้ว'),
//             backgroundColor: Colors.green,
//           ),
//         );

//         // รีโหลดหน้าจอ (ตะกร้าควรจะว่างเปล่า)
//         setState(() {
//           cartFuture = fetchCart();
//         });
//       }
...
//                         ),
//                       ),
//                       // เช็คสถานะ Loading เพื่อเปิด/ปิดปุ่ม
//                       onPressed: _isLoading
//                           ? null
//                           : () => confirmRent(cartItems),
//                       child: _isLoading
//                           ? const SizedBox(
//                               width: 24,
//                               height: 24,
